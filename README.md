...
```
cd existing_repo
git remote add origin https://git.cs.dal.ca/athaker/CSCI-5709-Tutorials.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.dal.ca/athaker/CSCI-5709-Tutorials/-/settings/integrations)
